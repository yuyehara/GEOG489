...
---
* Simulate how the final suitability categories change by increasing weight of a criteria
...
---
## Example 3: Predict Wolf Habitat Suitability
...
---
# List criteria and data source
<img src="../labs/lab2_data/misc/CH_criteria.png" width="800">
...
---
# Building Equation
* An empirical study using logistic regression
...
---
#### With empirical analysis, the equation and weights are not arbitary. <br><br>
#### Question: Any other issues with this approach?

---

#### Logistic regression still assume a linear relation between suitability and criteria, which is not usually true.

---
# Some thinkings
* What are the difference of using vector/raster for suitability modeling, and what are the pros and cons.
