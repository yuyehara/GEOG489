...
* After logged on, you will see your personal folder on My Computer.
---
## Account Management
* Do NOT save your work on the desktop!!! 
* Do NOT save your work on the C drive !!! 
* Save your work on a continuous basis to your personal folder, which is essentially a network folder. 
* Create folders for individual labs (lab1, lab2, ...) in your personal folder to easy track your work.
---
...
2. Python Scripting for Geoprocessing Workflows 
	...
	- You are given course codes in class to enroll in this self paced online courses.   
	- You will need to complete the online courses for Lab #1. 
	- For Lab #1, you have to turn in a lab report.
---
## Request an ESRI Training Account
1. Following the instruction to request and activate your ESRI training account.
